...
- The sales system API at `https://robocorp.com/inhuman-insurance-inc/sales-system-api` occasionally returns 500 errors, handled gracefully as `APPLICATION` exceptions
